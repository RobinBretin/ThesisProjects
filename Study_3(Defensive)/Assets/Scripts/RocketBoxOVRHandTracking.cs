...
public class RocketBoxOVRHandTracking : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        handR = new RocketBoxHand(RocketBoxHand.HandType.RightHand, new Vector3(180.0f, 0.0f, 180.0f)); 
    }
    ...
    class RocketBoxHand
    {
        ...
        public class FingerBone
        {
            ...
            private void SetProperties(Transform d1, Transform d2)
            {
                ...
                d1.transform.rotation = new Quaternion (d2.rotation.x,-d2.rotation.y,-d2.rotation.w,-d2.rotation.z);
